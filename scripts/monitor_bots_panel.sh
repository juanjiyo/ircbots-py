...
# VPS: panel (93.93.116.244) — Ubuntu 24.04
# Bots: iabot.py (MiLeNiUm), falkian.py (iND0MiTa)
# ============================================================
...
BOTS=(
    "MiLeNiUm|iabot|python3 iabot.py|python3 iabot.py"
    "ModBot|falkian|python3 falkian.py|python3 falkian.py"
)
