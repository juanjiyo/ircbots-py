...
class EventFormatter:
    ...
    def cambio(liga: str, color: str, equipo: str,
        ...
        if equipo:
            return f"{lf} {header} \x032del:\x03 \x02\x034{equipo}\x03\x02 {base}"
            ...
            if evento_hash != ultima_jugada_bd:
                ...
                if 'accion1.png' in icono and not _texto_es_cambio:  # Gol normal
                    ...
                    if jugador:
                        ...
                        mensaje_evento = f"{liga_formato} \x034T\x032arjeta \x034A\x032marilla\x03 \x038,8|_\x03 \x032(Min:\x0312 {minuto}{parte_formato}\x032)\x03 \x033»\x03 \x02\x0312{equipo_local}\x03\x02 \x032vs\x03 \x02\x0312{equipo_visitante}\x03\x02"
                    mensaje_titulo = None
                ...
                # accion23.png = Gol en tanda de penaltis
                # accion24.png = Fallo en tanda de penaltis
                # Formato especial: NO son goles del partido (marcador no cambia)
